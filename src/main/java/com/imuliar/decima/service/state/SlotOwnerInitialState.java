...
public class SlotOwnerInitialState extends AbstractState {
    ...
    private void publishToChat(Slot releasedSlot) {
        ...
        getMessageSender().sendMessageWithKeyboardToGroup("Slot # " + releasedSlot.getNumber() + "was released by user ...", inlineMarkup);
    }
