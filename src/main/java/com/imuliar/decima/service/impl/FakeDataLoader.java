...
public class FakeDataLoader {
    ...
    public void loadData() {
        if (reservationRepository.findAll().isEmpty()) {
            ...
            Stream.of(alexandrSlot, nastyaSlot, dianaSlot).forEach(s -> slotRepository.save(s));
            ...
            Stream.of(alexReservation, nastyaReservation, dianaSlotReservation).forEach(r -> reservationRepository.save(r));
        }
    }
}
