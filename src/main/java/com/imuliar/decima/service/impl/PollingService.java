...
public class PollingService {
    ...
    private void runTask() {
        ...
        for (Reservation res : reservationRepository.findUnpolled(today)) {
            messagePublisher.sendMessageWithKeyboard(res.getUserId().longValue(), messageSource.getMsg("msg.poll_gonna_park", res.getLanguageCode(), new String[]{today.toString()}),
